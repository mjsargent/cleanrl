...
if __name__ == "__main__":
    ...
    parser.add_argument('--levy_mu', type=int, default=1,
                        help="mu of levy dist to sample from")
    parser.add_argument('--levy_scale', type=float, default=0.01,
                        help="scale of levy dist to sample from")
...
def sampleFromLevy(mu, scale):
    noise = norm.ppf(1 - np.random.rand(1))**-2
    n = mu + scale * noise
    return np.floor(n)
